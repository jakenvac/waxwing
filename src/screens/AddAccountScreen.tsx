...
export default function AddAccountScreen({ navigation }: AddAccountScreenProps) {
  ...
  const handleAddAccount = async () => {
    ...
    try {
      ...
      console.log('[AddAccount] Token verified, fetching account details...');
      ...
      console.log('[AddAccount] Saving account:', account.name);
      ...
      console.log('[AddAccount] Account saved, navigating to Home');
